...
Results_filename = f"SA_Result_Single-Network_MA-MIP_WHOLE-IMAGE_{METHOD}_AE-ON-ALL-SAMPLES.csv"
...
with open(os.path.join(RESULTS_DIRECTORY,Results_filename), 'w', newline='') as csv_file:
    ...
    for NETWORK in NETWORKS:
        ...
        print(NETWORK)
        print("################")
        data = pd.read_csv(f"/home/amirhosein/HECKTOR2022/WHOLEIMAGE_MAMIP/ProcessedFeatures_{METHOD}/Processed_Features_{NETWORK}_MA-MIP_WHOLE-IMAGE_{METHOD}.csv")
        ...
        for train_idx, test_idx in kf.split(X):
            ...
            csv_writer.writerow({'Network': NETWORK,
                                ...
                                'KBest_CoxPHSA': CoxPHSA_CIndex_list[0],
                                'ICA_CoxPHSA': CoxPHSA_CIndex_list[1],
                                
                                'KBest_SVMSA': SVMSA_CIndex_list[0],
                                'ICA_SVMSA': SVMSA_CIndex_list[1]
                                })
            csv_file.flush()
            fold += 1
csv_file.close()