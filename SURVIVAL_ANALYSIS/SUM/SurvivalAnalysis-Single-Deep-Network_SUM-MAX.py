...
with open(os.path.join(RESULTS_DIRECTORY,Results_filename), 'w', newline='') as csv_file:
    ...
    for NETWORK in NETWORKS:
        ...
        data = pd.read_csv(f"/home/amirhosein/HECKTOR2022/WHOLEIMAGE_MAMIP/PROCESSED_FEATURES/ProcessedFeatures_{METHOD}/Processed_Features_{NETWORK}_MA-MIP_WHOLE-IMAGE.csv")
