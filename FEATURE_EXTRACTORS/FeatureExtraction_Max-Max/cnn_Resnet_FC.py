...
def featureextraction(rotate_img_list, model):
    ...
    final_feature = np.max(concat_features, axis=0)
...
if __name__ == "__main__":
    ...
    csv_filename = '/home/amirhosein/HECKTOR2022/WHOLEIMAGE_MAMIP/ExtractedFeatures_Max-Max/Features_' + NETWORK + '_MA-MIP_WHOLE-IMAGE_Max-Median.csv'
